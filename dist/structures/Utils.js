...
class TrackUtils {
    ...
    static getClosestTrack(unresolvedTrack) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield TrackUtils.manager.search({
                query: query,
                source: "youtubemusic"
            ...
            if (res.loadType !== "SEARCH_RESULT")
                ...
                if(res.tracks[0]) res.tracks[0].uri = unresolvedTrack.uri;  res.tracks[0].title = unresolvedTrack.title;   res.tracks[0].thumbnail = null;
